...
export const PLANS: PlanCard[] = [
  {
    ...
    features: [
      "보도자료 작성 월 3건",
      "기자 매칭 미리보기 (상위 5명, 발송 후보 3명)",
      "내 메일로 발송 월 10통 (SMTP 연결)",
      "미디어킷 1개 (웹 링크)",
    ],
    cta: "무료로 시작",
    popular: false,
  },
  {
    ...
    unit: "원/월",
    who: "1인 창업가 · 소상공인",
    features: ["기자 매칭 후보 무제한", "발송 월 100통", "답장 자동 분류·응대 초안", "미디어킷 3개 · 성과 리포트", "내 AI 연결 (Claude·ChatGPT·Gemini)"],
    cta: "Solo 시작하기",
    popular: true,
  },
  {
    ...
    unit: "원/월",
    who: "성장 스타트업",
    features: ["발송 월 500통", "예약·반복 발송", "경쟁사 노출 비교", "미디어킷 무제한 · 우선 지원", "내 AI 연결"],
    cta: "Growth 선택",
    popular: false,
  },
  {
    ...
    unit: "원~/월",
    who: "PR 대행사",
    features: ["멀티 클라이언트 · 팀 시트", "화이트라벨", "발송 무제한", "Gmail 연동 (‘언론홍보’ 라벨 워크플로우)", "API 연동", "내 AI 연결"],
    cta: "문의하기",
    popular: false,
  },
];
...
export const COMPARE_ROWS = [
  ...
  { feat: "발송 주체", agency: "대행사 명의", us: "내 메일 그대로(BYO-Email) — SMTP 전 플랜, Gmail 연동은 Agency" },
  { feat: "내 AI 플러그인", agency: "대행사 툴에 종속", us: "쓰는 Claude·ChatGPT·Gemini에 연결 (Solo↑)" },
...
export const STEPS = [
  ...
  { n: 4, title: "발송·응대", desc: "승인 후 내 메일로 발송. 답장은 7유형으로 자동 분류해 답장 초안까지 만들어 줍니다." },
];
